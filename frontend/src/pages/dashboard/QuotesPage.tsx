...
import { apiService, Quote } from '../../services/api';
...
const QuotesPage: React.FC = () => {
  ...
  const loadQuotes = async () => {
    try {
      ...
      const data = await apiService.searchQuotes(params);
      setQuotes(data);
      setTotalQuotes(data.length); // This might need to be adjusted based on API response
    } catch (err) {
  ...
  const loadAnalytics = async () => {
    try {
      const data = await apiService.getQuoteAnalyticsOverview();
      setAnalytics(data);
    } catch (err) {
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{analytics.total_quotes || 0}</p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{analytics.pending_quotes || 0}</p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{analytics.accepted_quotes || 0}</p>
              </div>
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex gap-4">
            ...
            >
              ...
              <option value="delivery_time-asc">Delivery: Fastest</option>
              <option value="delivery_time-desc">Delivery: Slowest</option>
            </select>
          ...
          <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
              <p className="text-sm text-gray-700">
                Showing <span className="font-medium">{(currentPage - 1) * quotesPerPage + 1}</span> to{' '}
                <span className="font-medium">
                  {Math.min(currentPage * quotesPerPage, totalQuotes)}
                </span>{' '}
