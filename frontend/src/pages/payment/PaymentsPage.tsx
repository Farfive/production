                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-medium text-gray-900">
                      {transactions.filter(t => t.status === TransactionStatus.SUCCEEDED).length}
                    </dd>
                  </dl>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-medium text-gray-900">
                      {transactions.filter(t => [TransactionStatus.PENDING, TransactionStatus.PROCESSING].includes(t.status)).length}
                    </dd>
                  </dl>
                </div>
              </div>
