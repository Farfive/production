...
const ModernNavigation: React.FC = () => {
      ...
      >
        ...
        <AnimatePresence>
          {isCollapsed && isHovered && (
            ...
            >
              <div className="bg-gray-900 dark:bg-gray-700 text-white px-3 py-2 rounded-lg shadow-xl">
  ...
  return (
    <motion.div
      className="fixed left-0 top-0 h-full bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-r border-gray-200/50 dark:border-gray-700/50 z-40 flex flex-col shadow-2xl"
