...
class TestPasswordValidator:
    ...
    def test_common_password(self):
        ...
        assert is_valid is False
        assert "Password is too common" in errors[0]
...
class TestAuthEndpoints:
    ...
    @patch('app.services.email.EmailService.send_email_verification')
    ...
    @patch('app.services.email.EmailService.send_password_reset')
