...
async def request_password_reset(
    ...
    try:
        try:
            ...
            from app.services.email_mock import send_password_reset_email
        # send_password_reset_email(user.email, user.first_name, reset_token)  # Async handled separately
