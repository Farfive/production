...
# Invoice Model for B2B Payments
class Invoice(Base):
    ...
    # Payment terms
    payment_terms = Column(String(20), nullable=False, default="NET_30")  # NET_30, NET_60, DUE_ON_RECEIPT
    ...
    client = relationship("User", back_populates="invoices_as_client", foreign_keys=[client_id])
    manufacturer = relationship("Manufacturer", back_populates="invoices_as_manufacturer", foreign_keys=[manufacturer_id])
